...
func (b Builder) createPorts(name string, gmmu *GMMU) {
	...
	gmmu.outsideTopPort = sim.NewLimitNumMsgPort(gmmu, 4096, name+".OutsideTop")
	gmmu.AddPort("OutsideTop", gmmu.outsideTopPort)
	...
	gmmu.outsideTopSender = sim.NewBufferedSender(
		gmmu.outsideTopPort, sim.NewBuffer(name+".OutsideTopSenderBuffer", 4096))
