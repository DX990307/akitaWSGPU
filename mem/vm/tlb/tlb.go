...
func (tlb *TLB) Tick(now sim.VTimeInSec) bool {
	...
	// if strings.Contains(tlb.Name(), "GMMU") {
	// 	fmt.Printf("TLB: %v\n", tlb)
	// }
...
func (tlb *TLB) fetchBottom(now sim.VTimeInSec, req *vm.TranslationReq) bool {
	...
	// fmt.Printf("%0.9f,%s,SendReqToBottom,%s,%d\n", float64(now), tlb.bottomPort.Name(), fetchBottom.TaskID, req.VAddr)

	// if req.VAddr == uint64(4800512) {
	// 	fmt.Printf("TLB: %v\n", tlb)
	// }
...
func (tlb *TLB) parseBottom(now sim.VTimeInSec) bool {
	...
	// if strings.Contains(tlb.bottomPort.Name(), "L1TLB") {
	// fmt.Printf("%0.9f,%s,GetResultFromBottom,%s,%d\n", float64(now), tlb.bottomPort.Name(), rsp.TaskID, page.VAddr)
	// }
	// if page.VAddr == uint64(1273856) {
	// 	fmt.Sprintf("TLB: %v\n", tlb)
	// }
